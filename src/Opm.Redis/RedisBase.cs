...
namespace Opm.Redis
{
    ...
    public class RedisBase
    {
        ...
        public static void List_AddRange<T>(string key, List<T> list)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
        ...
        public static void Set_AddRange<T>(string key, List<T> list)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
        ...
        /// <param name="dataKey"></param> 
        /// <returns></returns> 
        public static bool Hash_SetRange<T>(string key, string dataKey, List<T> list)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                bool isSuccess = true;
                ...
                {
                    string value = ServiceStack.Text.JsonSerializer.SerializeToString<T>(t);
                    isSuccess= redis.SetEntryInHash(key, dataKey, value);
                }
                return isSuccess;
            }
        }
        ...
        public static bool SortedSet_AddRange<T>(string key, List<T> list, double score)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                bool isSuccess = true;
                ...
                {
                    string value = ServiceStack.Text.JsonSerializer.SerializeToString<T>(t);
                    isSuccess= redis.AddItemToSortedSet(key, value, score);
                }
                return isSuccess;
            }
        }
        ...
        /// <param name="key"></param>
        /// <param name="t"></param>
        public static void EnqueueItemFromList<T>(string key ,T t)
        {
            using (IRedisClient redis=prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        public static void DequeueItemFromList<T>(string key)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
                redisTypedClient.DequeueItemFromList(redisTypedClient.Lists[key]);
            }
        }
        ...
        /// <param name="key"></param>
        /// <param name="t"></param>
        public static void PushItemToList<T>(string key, T t)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="key"></param>
        public static void PopItemFromList<T>(string key)
        {
            using (IRedisClient redis = prcm.GetClient())
            {
                var redisTypedClient = redis.GetTypedClient<T>();
                redisTypedClient.PopItemFromList(redisTypedClient.Lists[key]);
            }
        }
